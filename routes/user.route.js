...
var transporter = nodemailer.createTransport({ service: 'gmail', auth: { user: 'med.omar.moalla13@gmail.com', pass: 'wffh qlnq qwca kqle' }, tls: { rejectUnauthorized: false } })
router.post('/register', async (req, res) => {
    try {
        ...
        var mailOption = {
            from: '"verify your email " <med.omar.moalla13@gmail.com>',
            to: newUser.email,
            subject: 'vérification your email ',
            html:
                `<h2>${newUser.firstname}! thank you for registreting on our website</h2>
    <h4>please verify your email to procced.. </h4>
    <a href="http://${req.headers.host}/api/user/status/edit?email=${newUser.email}">click here</a>`
        }
